import { CacheNode, CacheOptions, CacheMetrics } from '../types/cache';
...
export class LRUCache<T = any> {
  ...
  private isExpired(node: CacheNode<T>, now?: number): boolean {
  ...
  private isValidValue(value: T): boolean {
    ...
    if (typeof value === 'object' && value !== null) {
      ...
      if (keys.includes('constructor') && (value as any).constructor !== Object && (value as any).constructor !== Array) {
        return false;
      }
    }
